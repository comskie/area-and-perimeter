...
<template>
  ...
  <main
    class="container grid justify-center min-h-screen p-2 transition-all ease-linear bg-gradient-to-t from-indigo-100 dark:bg-neutral-800 dark:from-inherit dark:text-white"
  >
